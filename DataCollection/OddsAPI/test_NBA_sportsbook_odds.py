#!/usr/bin/env python3
"""
Test script to collect sportsbook odds for just 3 NBA games
Quick test version of get_NBA_sportsbook_odds.py
"""
...
def test_collect_sportsbook_odds(kalshi_data_file: str, output_file: str, max_games: int = 3):
    """
    Test version - collect sportsbook odds for just a few NBA games
    """
    ...
    # NBA team mapping for parsing tickers
    ...
    output_data = {
        ...
        'description': f'TEST: Sportsbook odds 5 minutes before NBA game start (first {max_games} games)',
        'source': 'The Odds API',
...
def main():
    ...
    output_file = DATA_DIR / "test_nba_sportsbook_odds.json"
